...
export default function PropertyCard({ property }) {
  const { id, title, price, city_id, num_rooms, size_m2, status, images, neighborhood } = property;
  ...
  return (
    <Link to={`/properties/${id}`} className="group flex flex-col rounded-xl border border-gray-200 bg-white shadow-soft hover:shadow-card hover:border-brand-200 transition-all overflow-hidden">
